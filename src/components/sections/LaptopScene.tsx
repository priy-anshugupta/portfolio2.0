...
export function LaptopScene() {
  ...
  return (
    <section
      ref={sectionRef}
      id="about"
      className="relative overflow-hidden bg-surface px-4 py-8 sm:px-8 lg:min-h-screen lg:px-12 lg:py-24"
    >
      <div
        ref={stageRef}
        className="relative flex min-h-min items-center justify-center opacity-0 lg:min-h-[calc(100vh-12rem)]"
